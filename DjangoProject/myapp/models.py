...
class Mechanic(models.Model): 
    ...
    lng =  models.CharField(max_length=1000,default=' ')
    def __str__(self):
        return f'{self.mechanicCategory_id} '
...
class Products(models.Model): 
    ...
    def __str__(self):
        return f'{self.category_id} {self.status_id} '
...
class Order(models.Model): 
    ...
    lng =  models.CharField(max_length=1000,default=' ')
    def __str__(self):
        return f'{self.buyer_id} {self.seller_id} '
...
class Orderproducts (models.Model):
    ...
    def __str__(self):
        return f'{self.products_id} {self.order_id} {self.orderproducts_name} {self.orderproducts_price} {self.delivery_options} {self.payment_options}'
...
class Carts (models.Model):
    ...
    def __str__(self):
        return f'{self.user_id} {self.products_id} {self.order_id}  '
...
class Conversations(models.Model):
    ...
    def __str__(self):
        return f'{self.user} {self.admin} {self.user1}  '
